...
3-1, and `r formattable::comma(jp51, digits = 0)` in Justice of the Peace Court 5-1. The `r formattable::comma(totObsCases, digits = 0)` observed cases represent `r paste0(jpCasesCty$perAllCases*100, "%") `
...
jpCasesObs %>%
  ...
  formatCurrency(c("1-1", "1-2", "3-1","4-1", "5-1", "Total"),
                 interval = 3,
                 mark = ",",
                 currency = "",
                 digits = 0) %>%
...
cpal_plot(zeroGrob(),
          cpal_title(string = "Across all observed cases, the judge ruled in favor of the landlord in XX% of cases and in favor of the tenant in YY% of cases.",
                     width = 75),
          plotOutcome, 
          cpal_logo_text(), 
          ncol = 1,
