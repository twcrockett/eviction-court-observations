...
**Through `r format(endDate)`, `r formatC(paste(nrow(totevic1)), big.mark = ",")` evictions have been filed in Dallas County, an average of `r avgevic1` per day.**
...
time period in 2021. Evictions have been on the rise since the end of the CDC Eviction Moratorium in August 2021, and Dallas County realized its highest one-month filing total in at least five years in **`r paste(month(highestMonth$dateFiled), year(highestMonth$dateFiled))`**, with **`r formatC(highestMonth$totevic, big.mark = ",")`** evictions filed.
...
of the Peace Court 1-1 and expanded to Dallas County Justice of the Peace Courts 3-1 and 5-1 in 2022. **??? Additional Courts for 2023?**
