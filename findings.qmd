...
plotCases <- jpCasesObs %>%
  ...
  geom_text(aes(label = paste(round(perCases*100, digits = 1), "%"), x = 1.1),
...
grid.arrange(plotCases, cpal_logo_text(), 
             ncol = 1,
             heights = c(30, 1))
...
plotReason <- evicReason %>%
  ...
  geom_bar(stat="identity") +
  geom_text(aes(label = ifelse(perCases >= 0.1, paste(round(perCases*100, digits = 1), "%"), ""), x = 1.0),
...
grid.arrange(plotReason, cpal_logo_text(), 
             ncol = 1,
             heights = c(30, 1))
...
plotAppear <- caseAppear %>%
  ...
  geom_bar(stat = "identity") +
  geom_text(aes(label = paste(round(AppearPer*100, digits = 1), "%")),
...
grid.arrange(plotAppear, cpal_logo_text(), 
             ncol = 1,
             heights = c(30, 1))
```
